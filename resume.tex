...
\begin{itemize}[leftmargin=0.15in, label={}]
      \small{\item{
    \textbf{Languages}{: TypeScript, JavaScript, Python, Go, C++, HTML, CSS, SQL, Shell, Java} \\
    \textbf{Frameworks/Libraries}{: Svelte, Angular, RxJS, Next.js} \\
    \textbf{Cloud/DevOps}{: Docker, Amazon Web Services (AWS), Google Cloud Platform (GCP), Linux, Nix, Terraform, CI/CD, Git} \\
    \textbf{Databases/Caching}{: PostgreSQL, MongoDB, Redis, Deno KV} \\
    \textbf{Other Tools/Concepts}{: Object-Oriented Programming, Data Structures, Algorithms, Scripting, Protobuf, RDF, OpenAPI, Zero-Knowledge Systems, Anyone Protocol, Relational Databases, Non-Relational Databases, Graph Databases, Computer Networks}
    }}
 \end{itemize}
