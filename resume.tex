...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem{Conducted technical reviews and cross-team presentations for feature launches.}
    \resumeItemListEnd
...
\section{Leadership}
\resumeSubHeadingListStart
  \resumeItem{\textbf{Open Source President} $|$ ACM, CSUF $|$ Scaled developer community to \textbf{100+ contributors} on \textbf{20+ open-source projects} $|$ \textit{Next.js, PostgreSQL, Node.js, Discord API}}
  \resumeItem{\textbf{ICPC Team Lead} $|$ ACM, CSUF $|$ Led team strategy and algorithmic preparation for collegiate programming competitions}
