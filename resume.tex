...
\begin{itemize}[leftmargin=0.15in, label={}]
      \small{\item{
    \textbf{Languages}{: TypeScript, JavaScript, Python, Go, C++, HTML, CSS, SQL, Shell, Java, MATLAB, BASIC, Processing} \\
    \textbf{Frameworks/Libraries}{: Svelte, Angular, RxJS, Next.js, TensorFlow, HuggingFace, Fresh} \\
    \textbf{Cloud/DevOps}{: Docker, Amazon Web Services (AWS), Google Cloud Platform (GCP), Linux, Nix, Terraform, CI/CD, Git} \\
    \textbf{Databases/Caching}{: Redis, MongoDB, PostgreSQL, BigTable, SingleStore, Deno KV} \\
    \textbf{Other Tools/Concepts}{: Protobuf, RDF, OpenAPI, Zero-Knowledge Systems, Anyone Protocol, Data Structures, Algorithms, Relational Databases, Non-Relational Databases, Graph Databases, Computer Networks}
    }}
 \end{itemize}
